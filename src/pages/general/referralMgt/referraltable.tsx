          ...
          <tbody>
            {referrals.map((referral, index) => (
              ...
              >
                ...
                <td className="p-4 text-[12px] text-black text-center font-semibold">
                  {referral.amountEarned}
                </td>
                <td className="p-4 text-center">
                  <button
                    onClick={() => handleViewAll(referral)}
                    className="px-10 py-2 rounded-lg text-[12px] font-medium transition-colors cursor-pointer bg-[#E53E3E] text-white hover:bg-[#D32F2F]"
                  >
                    View All
                  </button>
                </td>
