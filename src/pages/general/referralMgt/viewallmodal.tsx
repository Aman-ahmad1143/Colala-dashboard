...
const ViewAllModal: React.FC<ViewAllModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="bg-white  w-[560px] h-[526px] overflow-hidden shadow-2xl relative"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-5 mt-2 border-b  border-gray-200">
        ...
        <div className="p-5 max-h-[500px] overflow-y-auto">
          <div className="space-y-1">
            {referredUsers.map((user) => (
              <div
                key={user.id}
                className="flex items-center justify-between py-3 rounded-2xl border border-gray-100 last:border-b-0"
              >
