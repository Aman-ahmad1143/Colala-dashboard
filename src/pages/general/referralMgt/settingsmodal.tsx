...
const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white  w-[560px] h-[411px] shadow-2xl"
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <button
            onClick={handleSave}
            className="w-full h-[60px] mt-3 bg-[#E53E3E] text-white py-3 rounded-lg font-medium text-[14px] hover:bg-[#D32F2F] transition-colors"
          >
            Save
          </button>
        </div>
