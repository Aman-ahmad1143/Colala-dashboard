...
const Analytics = () => {
  ...
  const exportOptions = ["All User data", "All Revenue Data", "All Buyer app data", "All Seller data"];
  const timeOptions = ["This Week", "Last Month", "Last 6 Months", "Last Year", "All time"];
    ...
    <div>
        ...
        <div className="flex flex-row justify-between pt-5 pb-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center">
                  <button className="cursor-pointer text-[10px] font-medium">Export CSV</button>
                </div>
                <div className="flex items-center ml-3">
                  <img src={images.dropdown} alt="dropdown" className="filter invert" />
                </div>
              </div>

              {isExportDropdownOpen && (
                <div className="absolute text-[10px] top-full right-0 mt-1 w-[160px] bg-white border border-[#989898] rounded-lg shadow-lg z-10">
                  {exportOptions.map((option) => (
                    <div
                      key={option}
                      className="px-4 py-3 hover:bg-gray-200 cursor-pointer rounded-lg text-left text-gray-700"
            ...
            <div className="relative">
              <div
                className="flex flex-row border border-[#989898] rounded-lg p-3 cursor-pointer text-[10px]"
              ...
              {isTimeDropdownOpen && (
                <div className="absolute top-full right-0 mt-1 w-[140px] bg-white border border-[#989898] rounded-lg shadow-lg z-10">
                  {timeOptions.map((option) => (
                    <div
                      key={option}
                      className="px-4 py-3 hover:bg-gray-200 text-[10px] rounded-lg cursor-pointer text-left"
      ...
      <div className="p-6 pb-0">
        <div className="flex flex-row gap-6">
          ...
          <div className="border border-[#989898] rounded-2xl bg-white" style={{ width: '716px', height: '411px' }}>
          ...
          <div className="border border-[#989898] rounded-2xl bg-white" style={{ width: '412px', height: '411px' }}>
            <div className="flex flex-row justify-between bg-[#F2F2F2] rounded-t-2xl p-5">
              <div className="flex flex-row items-center gap-2">
                <span>
                  <img
        ...
        <div className="flex flex-row gap-6 mt-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            {/* Total Users Card */}
            <div className="bg-white border border-gray-300 rounded-2xl" style={{ width: '272px', height: '261px' }}>
              <div className="p-6 flex flex-col h-full">
                <h3 className="text-lg font-semibold text-center mb-6">Total Users</h3>
                ...
                <div className="text-center mt-auto">
                  ...
                  <div className="text-[10px]  text-gray-600">
                    <span className="text-green-600 font-semibold">500</span> increase from last week
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-300 rounded-2xl" style={{ width: '272px', height: '261px' }}>
              <div className="p-6 flex flex-col h-full">
                <h3 className="text-lg font-semibold text-center mb-6">Total Sellers</h3>
                ...
                <div className="text-center mt-auto">
                  <div className="text-3xl font-bold text-black mb-2">100,000</div>
                  <div className="text-[10px] text-gray-600">
                    <span className="text-green-600 font-semibold">500</span> increase from last week
                  </div>
                </div>
            ...
            <div className="bg-white border border-gray-300 rounded-2xl" style={{ width: '272px', height: '261px' }}>
              <div className="p-6 flex flex-col h-full">
                <h3 className="text-lg font-semibold text-center mb-6">Total Buyers</h3>
            ...
            <div className="bg-white border border-gray-300 rounded-2xl" style={{ width: '272px', height: '261px' }}>
              <div className="p-6 flex flex-col h-full">
                <h3 className="text-lg font-semibold text-center mb-6">Revenue Generated</h3>
                ...
                <div className="text-center mt-auto">
                  <div className="text-3xl font-bold text-black mb-2">N200,000</div>
                  <div className="text-[10px] text-gray-600">
                    <span className="text-green-600 font-semibold">500</span> increase from last week
                  </div>
                </div>
          ...
          <div className="border border-[#989898] rounded-2xl bg-white" style={{ width: '568px', height: '411px' }}>
            <div className="flex flex-row justify-between bg-[#F2F2F2] rounded-t-2xl p-5">
              <div className="flex flex-row items-center gap-2">
                <span>
                  <img
              ...
              <div className="flex flex-row items-center gap-4">
                <div className="relative">
                  <div className="flex flex-row items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2">
                    <div className="bg-[#E53E3E] w-3 h-3 rounded-sm"></div>
                ...
                <div className="relative">
                  <div className="flex flex-row items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2">
                    <div className="bg-[#000000] w-3 h-3 rounded-sm"></div>
                    <span className="text-sm">Prom Revenue</span>
                    <img src={images.dropdown} alt="dropdown" className="w-3 h-3" />
                  </div>
                </div>
              </div>
            ...
            <div className="p-5">
              ...
              <div className="flex flex-row justify-center gap-8 mt-4">
                ...
                <div className="flex flex-row items-center gap-2">
                  ...
                  <span className="text-sm font-medium">Promotions Revenue</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          {/* Top Row */}
          <div className="bg-[#FF0000] text-white rounded-[15px] p-4 flex items-center gap-3 pl-2" style={{ width: '174px', height: '68px' }}>
          ...
          <div className="bg-[#008000] text-white rounded-[15px] p-4 flex items-center gap-3 pl-2" style={{ width: '174px', height: '68px' }}>
            <div className="w-2 h-9 bg-white rounded"></div>
            <div>
          ...
          <div className="bg-[#0000FF] text-white rounded-[15px] p-4 flex items-center gap-3 pl-2" style={{ width: '174px', height: '68px' }}>
            <div className="w-2 h-9 bg-white rounded"></div>
            <div>
          ...
          {/* Bottom Row */}
          <div className="bg-[#800080] text-white rounded-[15px] p-4 flex items-center gap-3 pl-2" style={{ width: '174px', height: '68px' }}>
            <div className="w-2 h-9 bg-white rounded"></div>
            <div>
          ...
          <div className="bg-[#FFA500] text-white rounded-[15px] p-4 flex items-center gap-3 pl-2" style={{ width: '174px', height: '68px' }}>
            <div className="w-2 h-9 bg-white rounded"></div>
            <div>
          ...
          <div className="bg-black text-white rounded-[15px] p-4 flex items-center gap-3 pl-2" style={{ width: '174px', height: '68px' }}>
            <div className="w-2 h-9 bg-white rounded"></div>
            <div>
