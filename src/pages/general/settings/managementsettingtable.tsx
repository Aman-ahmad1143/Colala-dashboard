                ...
                <td className="p-4">
                  <div className="flex items-center justify-center gap-2">
                    <button
                      ...
                      className="px-6 py-2.5 rounded-lg text-[10px] font-medium transition-colors cursor-pointer bg-[#E53E3E] text-white hover:bg-[#D32F2F]"
                    >
                      Admin Details
                    </button>
                    <button
                    ...
                    {admin.role !== "Owner" && (
                      <button
                        ...
                        className="p-1.5 hover:bg-gray-100 rounded transition-colors"
                      >
                        <img src={images.Trash} alt="Delete" className="w-8 h-8 p-1 rounded-lg border border-[#989898] " />
                      </button>
                    )}
                  </div>
                </td>
