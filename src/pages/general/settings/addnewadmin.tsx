...
const AddNewAdmin: React.FC<AddNewAdminProps> = ({ isOpen, onClose, onAddAdmin }) => {
  ...
  const modalContent = (
    <div 
      className="fixed inset-0 backdrop-brightness-50 -mt-4 bg-opacity-50 flex items-start justify-end z-[9999]"
      onClick={(e) => {
    ...
    >
      <div 
        className="bg-white  w-full max-w-md mx-4 p-6 relative z-[10000]"
        onClick={(e) => {
      ...
      >
        {/* Header */}
        <div className="flex items-center p-2 border-b border-[#787878] justify-between mb-6">
          <h2 className="text-[16px] font-semibold text-gray-900">Add New Admin</h2>
          <button
            onClick={handleClose}
            className="p-1 hover:bg-gray-100 rounded-full transition-colors"
          >
           <img src={images.close} alt="Close" className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex justify-center mb-6">
          <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center">
           <img src="/public/assets/layout/image.svg" alt="Profile" className="w-10 h-10 " />
          </div>
        </div>
